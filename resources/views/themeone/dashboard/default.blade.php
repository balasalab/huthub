...
<div id="rightSide">
    ...
    <div class="topNav">
        <div class="wrapper">
            <div class="welcome"><a href="#" title=""><img src="<?php echo $assert; ?>images/userPic.png" alt="" /></a><span>Howdy, Eugene!</span></div>
            <div class="userNav">
                <ul>
                    <li><a href="#" title=""><img src="<?php echo $assert; ?>images/icons/topnav/profile.png" alt="" /><span>Profile</span></a></li>
                    <li><a href="#" title=""><img src="<?php echo $assert; ?>images/icons/topnav/tasks.png" alt="" /><span>Tasks</span></a></li>
                    <li class="dd"><a title=""><img src="<?php echo $assert; ?>images/icons/topnav/messages.png" alt="" /><span>Messages</span><span class="numberTop">8</span></a>
                    ...
                    <li><a href="#" title=""><img src="<?php echo $assert; ?>images/icons/topnav/settings.png" alt="" /><span>Settings</span></a></li>
                    <li><a href="login.html" title=""><img src="<?php echo $assert; ?>images/icons/topnav/logout.png" alt="" /><span>Logout</span></a></li>
                </ul>
            </div>
            <div class="clear"></div>
        </div>
    ...
    <div class="wrapper">
        ...
        <div class="widget chartWrapper">
            <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Chart</h6></div>
        ...
        <div class="widgets">
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/users.png" alt="" class="titleIcon" /><h6>Partners list</h6></div>
                    <ul class="partners">
                        <li>
                            <a href="#" title="" class="floatL"><img src="<?php echo $assert; ?>images/user.png" alt="" /></a>
                            <div class="pInfo">
                                <a href="#" title=""><strong>Dave Armstrong</strong></a>
                                <i>Creative director at Google Inc. Zurich</i>	
                            </div>
                            <div class="pLinks">
                                <a href="#" title="Direct call" class="tipW"><img src="<?php echo $assert; ?>images/icons/pSkype.png" alt="" /></a>
                                <a href="#" title="Send an email" class="tipW"><img src="<?php echo $assert; ?>images/icons/pEmail.png" alt="" /></a>
                            </div>
                            <div class="clear"></div>
                        </li>
                        <li>
                ...
                <div class="widget">
                    <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Website statistics</h6></div>
                ...
                <div class="widget">
                    <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/refresh4.png" alt="" class="titleIcon" /><h6>Latest updates</h6></div>
            ...
            <div class="oneTwo">
                ...
                <!-- New users widget -->
                <div class="widget">
                    <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/add.png" alt="" class="titleIcon" /><h6>New users</h6></div>
                    <div class="wUserInfo">
                        <a href="#" title="" class="wUserPic"><img src="<?php echo $assert; ?>images/user.png" alt="" /></a>
                        <ul class="leftList">
                ...
                <div class="widget">
                    <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/timer.png" alt="" class="titleIcon" /><h6>My tasks</h6><div class="num"><a href="#" class="blueNum">+245</a></div></div>
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable taskWidget">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="actBtns"><a href="#" title="Update" class="tipS"><img src="<?php echo $assert; ?>images/icons/edit.png" alt="" /></a><a href="#" title="Remove" class="tipS"><img src="<?php echo $assert; ?>images/icons/remove.png" alt="" /></a></td>
                            </tr>
                            <tr>
        ...
        <!-- Events calendar -->
        <div class="widget">
            <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/monthCalendar.png" alt="" class="titleIcon" /><h6>Events</h6></div>
        ...
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        <td><img src="<?php echo $assert; ?>images/icons/tableArrows.png" alt="" /></td>
                        <td>Image</td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center"><a href="images/big.png" title="" rel="lightbox"><img src="<?php echo $assert; ?>images/user.png" alt="" /></a></td>
    	...
    	<!-- Dynamic table -->
        <div class="widget">
            <div class="title"><img src="<?php echo $assert; ?>images/icons/dark/full2.png" alt="" class="titleIcon" /><h6>Dynamic table</h6></div>                          
